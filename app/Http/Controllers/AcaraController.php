...
class AcaraController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $post = Acara::create([
            ...
            'start_acara_time' => $request->start_acara_time ? date('Y-m-d ').' '.$request->start_acara_time.':00' : null,
            'end_acara_time' => $request->end_acara_time ? date('Y-m-d ').' '.$request->end_acara_time.':00' : null,
