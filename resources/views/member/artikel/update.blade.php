        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm bg-dark2 dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{route('member.artikel.update.post')}}" method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="mb-5 img-preview-div" style="@if(!$post->banner)display:none;@endif">
                            ...
                            <img for="image" src="/uploads/artikel/image/{{$post->banner}}" alt="" class="img-preview img-fluid" style="display:hidden; max-width:200px; max-height:150px;">
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                          <a href="{{route('member.artikel.delete', ['id'=>$post->id])}}" type="button" class="btn btn-danger me-3">Delete Berita</a>

                          <div>
                            <a href="{{route('member.artikel')}}" type="button" class="btn btn-secondary me-3">Cancel</a>
    ...
    <x-slot name="script">
        <script type="text/javascript">
            ...
            function addNewCategory(){
              const input = document.getElementById("myInput");
              fetch("{{route('member.artikel.newCategory.add')}}?name="+input.value)
            ...
            title.addEventListener('keyup', function(){
                fetch("{{route('member.artikel.slug.check')}}?title="+title.value)
                .then(response => response.json())
