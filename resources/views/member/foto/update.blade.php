        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm bg-dark2 dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{route('member.foto.update.post')}}" method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="mb-5 img-preview-div" style="@if(!$post->banner)display:none;@endif">
                            ...
                            <img for="image" src="/uploads/foto/image/{{$post->banner}}" alt="" class="img-preview img-fluid" style="display:hidden; max-width:200px; max-height:150px;">
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                          <a href="{{route('member.foto.delete', ['id'=>$post->id])}}" type="button" class="btn btn-danger me-3">Delete Berita</a>
    ...
    <x-slot name="script">
        <script type="text/javascript">
            ...
            function addNewCategory(){
              const input = document.getElementById("myInput");
              fetch("{{route('member.foto.newCategory.add')}}?name="+input.value)
            ...
            title.addEventListener('keyup', function(){
                fetch("{{route('member.foto.slug.check')}}?title="+title.value)
                .then(response => response.json())
