                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="row p-0 m-0">
                        {{-- <div class="col-xl-8" style=""> --}}
                            ...
                            <p class="mt-1" style="font-size:12px; color: color:rgba(255, 255, 255, 0.700)">{{$post->video_source}}</p>
                            <div>
                                <?=$post->content?>
                            </div>
                    </div>
                            ...
                            @if($pc->saved == 0)
                                <form action="{{route('postcontent.save')}}" method="POST" enctype="multipart/form-data"> @csrf
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="content" name="content" value="https://www.youtube.com/watch?v={{ $pc->content }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="source" class="form-label">Video Description (optional)</label>
                                        <input type="text" class="form-control" id="source" name="source" value="{{ $pc->source }}">
                                    </div>
                                    @elseif($pc->type=='text')
                            ...
                            @else
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <iframe style="width:100%; height:300px;" src="https://www.youtube.com/embed/{{$pc->content}}"></iframe>
                                    </div>
                                </div>
                                    <p class="mt-1" style="font-size:12px; color: color:rgba(255, 255, 255, 0.700)">{{$pc->source}}</p>
                                @elseif($pc->type=='text')
