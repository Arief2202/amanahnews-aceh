                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{route('member.e-catalog.update.post')}}" method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $ecatalog->title) }}">
                            @error('title')
                              <div class="invalid-feedback">
                                  {{ $message }}
                              </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $ecatalog->slug) }}">
                            @error('slug')
                              <div class="invalid-feedback">
                                  {{ $message }}
                              </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('owner') is-invalid @enderror" id="owner" name="owner" value="{{ old('owner', $ecatalog->owner) }}">
                            @error('owner')
                              <div class="invalid-feedback">
                                  {{ $message }}
                              </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" rows="3" name="description" value="{{ old('description', $ecatalog->description) }}">{{ old('description', $ecatalog->description) }}</textarea>
                            @error('description')
                              <div class="invalid-feedback">
                                  {{ $message }}
                              </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" value="{{ old('address', $ecatalog->address) }}">
                            @error('address')
                              <div class="invalid-feedback">
                                  {{ $message }}
                              </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('hubungi') is-invalid @enderror" id="hubungi" name="hubungi" value="{{ old('hubungi', $ecatalog->hubungi) }}" placeholder="Ex. https://wa.me/+6212345678">
                            @error('hubungi')
                              <div class="invalid-feedback">
                                  {{ $message }}
                              </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('sosmed') is-invalid @enderror" id="sosmed" name="sosmed" value="{{ old('sosmed', $ecatalog->sosmed) }}" placeholder="Ex. https://instagram.com/amanahnews">
                            @error('sosmed')
                              <div class="invalid-feedback">
                                  {{ $message }}
                              </div>
