        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner" >
              ...
              <div class="carousel-item @if($a==0) active @endif" data-bs-interval="3000">
                ...
                <img src="/uploads/post/image/{{$carousel_item->banner}}" class="d-block w-100" alt="..." style="height: 100vh; background-size:cover; opacity:30%;z-index:1; overflow:hidden;">
    ...
    <section class="section" style="padding-top:0px;">
      <div class="container">
        ...
        <div class="row">
          ...
          <?php
            if(isset($selected_tag)) $lainnya = $lainnya->post;
          ?>
