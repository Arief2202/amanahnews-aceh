        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner" >
              ...
              <div class="carousel-item @if($a==0) active @endif" data-bs-interval="3000">
                ...
                <img style="object-fit:cover;" src="/uploads/post/image/{{$carousel_item->banner}}" class="d-block w-100" alt="..." style="height: 100vh; background-size:cover; opacity:30%;z-index:1; overflow:hidden;">
          ...
          <div class="col d-flex justify-content-end align-items-end mb-2">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="{{route('berita.category', ['slug'=>$category->slug])}}">{{$category->name}}</a></li>
                @endforeach
              </ul>
            </div>
          </div>
              ...
              @foreach($newest as $a=>$new)
                ...
                <div class="mb-3 w-100" data-aos="fade-up" data-aos-delay="50">
                  <a href="{{route('berita.detail', ['slug' => $new->slug])}}">
                    ...
                    <img style="object-fit:cover;" src="/uploads/post/image/{{$new->banner}}" alt="" style="max-height:350px;width: 100%">
            ...
            @foreach($trendings as $i=>$trending)
              <div class="mb-3 w-100" data-aos="fade-left" data-aos-delay="100">
                <a href="{{route('berita.detail', ['slug' => $trending->slug])}}">
                  ...
                  <img style="object-fit:cover;" src="/uploads/post/image/{{$trending->banner}}" alt="" style="max-height:300px;width: 100%">
          ...
          <div class="col-xl-4 mb-3">
            <a href="{{route('berita.detail', ['slug' => $lainnya->slug])}}">
              <div class="" style="width:100%;" data-aos="flip-left" data-aos-delay="{{($i%3)*100}}">
                <img style="object-fit:cover;" src="/uploads/post/image/{{$lainnya->banner}}" alt="" style="max-height:300px;width: 100%">
