                ...
                <div class="carousel-inner">
                    ...
                    @foreach ($carousel_items as $a => $carousel_item)
                        ...
                        <div class="carousel-item @if ($a == 0) active @endif" data-bs-interval="3000">
                            ...
                            <img src="/uploads/foto/image/{{ $carousel_item->banner }}" class="d-block w-100" alt="..."
                            ...
                            <div class="p-3 carousel-caption d-none d-md-block h-100" style="width: 1000px">
                                <div
                                    ...
                                    <div class="mt-4 d-flex justfiy-content-start align-items-start">
                                        <a href="{{ route('foto.detail', ['slug' => $carousel_item->slug]) }}"
                    ...
                    @foreach ($carousel_items as $a => $carousel_item)
                        <a href="{{ route('foto.detail', ['slug' => $carousel_item->slug]) }}">
                            <div class="carousel-item @if ($a == 0) active @endif"
                                ...
                                <img src="/uploads/foto/image/{{ $carousel_item->banner }}"
        ...
        <div class="container">
            <div class=" d-flex justify-content-center w-100">
                <form action="" method="get">
                    <div class="row">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Cari Foto yang ingin anda lihat"
                        ...
                        <ul class="dropdown-menu">
                            @foreach ($categories as $category)
                                <li><a class="dropdown-item"
                                        href="{{ route('foto.category', ['slug' => $category->slug]) }}">{{ $category->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                ...
                <div class="col-xl-8 ps-2 pe-2">
                    ...
                    @if (strval(request('search')) > 0)
                        @foreach ($search['items'] as $a => $new)
                            ...
                            $content = str_replace('</div>', '', $content);
                            ?>
                            <div class="mb-3 w-100 photo-link-hover" data-aos="fade-up" data-aos-delay="50">
                                <a href="{{ route('foto.detail', ['slug' => $new->slug]) }}">
                                    ...
                                    <img src="/uploads/foto/image/{{ $new->banner }}" alt=""
                                    ...
                                    <a
                                        href="/foto/detail/{{ $new->slug }}"style=" color:#000000;font-size:16px;font-weight:600;text-align:left;">Lihat
                                        Foto ></a>
                                    <hr>
                                </a>
                            </div>
                                ...
                                <nav aria-label="...">
                                    ...
                                    <ul class="pagination">
                                        <li class="page-item @if ($search['currentPage'] <= 1) disabled @endif">
                                            <a href="{{ route('foto', ['page' => $search['currentPage'] - 1]) }}&search={{ request('search') }}"
                                        ...
                                        @if ($search['lastPage'] > 3)
                                                ...
                                                @for ($a = 1; $a <= 3; $a++)
                                                    ...
                                                    @else
                                                        <li class="page-item"><a class="page-link"
                                                                href="{{ route('foto', ['page' => $a]) }}&search={{ request('search') }}">{{ $a }}</a>
                                                        </li>
                                                    @endif
                                                @endfor
                                                <li class="page-item"><a class="page-link"
                                                        href="{{ route('foto', ['page' => $per5 * 3 + 4]) }}&search={{ request('search') }}">{{ $per5 * 3 + 4 }}</a>
                                                </li>
                                            ...
                                            @else
                                                <li class="page-item"><a class="page-link"
                                                        href="{{ route('foto', ['page' => $per5 * 3 - 1]) }}&search={{ request('search') }}">{{ $per5 * 3 - 1 }}</a>
                                                </li>
                                                ...
                                                @endfor
                                                <li class="page-item"><a class="page-link"
                                                        href="{{ route('foto', ['page' => $per5 * 3 + 3]) }}&search={{ request('search') }}">{{ $per5 * 3 + 3 }}</a>
                                                </li>
                                            @endif
                                        @else
                                        ...
                                        <li class="page-item @if ($search['currentPage'] >= $search['lastPage']) disabled @endif">
                                            <a class="page-link"
                                                href="{{ route('foto', ['page' => $search['currentPage'] + 1]) }}&search={{ request('search') }}">Next</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    @foreach ($trendings as $i => $trending)
                        <div class="mb-3 w-100" data-aos="fade-left" data-aos-delay="100">
                            <a href="{{ route('foto.detail', ['slug' => $trending->slug]) }}">
                                ...
                                <img src="/uploads/foto/image/{{ $trending->banner }}" alt=""
                            ...
                            <a href="{{ route('foto.detail', ['slug' => $lainnya->slug]) }}">
                                <div class="" style="width:100%;" data-aos="flip-left"
                                    ...
                                    <div class="col-12"
                                        ...
                                        <img src="/uploads/foto/image/{{ $lainnya->banner }}" alt=""
