...
@section('main')
            ...
            <nav class="breadcrumbs">
              <div class="container">
                <ol>
                  ...
                  <li><a href="/berita/tag">Kategori</a></li>
                  <li><a href="/berita/tag/{{$selected->slug}}">{{$selected->name}}</a></li>
                </ol>
              </div>
            </nav>
          </div><!-- End Page Title -->
    ...
    <section class="section" style="">
      <div class="container">
        ...
        <div class="row">
          <div class="col">
            <h3 class="mt-5" style="font-weight:500;margin:0px;padding:0px;text-align:left;">Tag {{$selected->name}} dari AMANAH</h3>
          </div>
          ...
          <div class="col-xl-8 ps-5 pe-5">
              @foreach($filters as $a=>$new)
                ...
                <div class="mb-3 w-100" data-aos="fade-up" data-aos-delay="50">
                  <a href="{{route('berita.detail', ['slug' => $new->post->slug])}}">
                    ...
                    <img src="/uploads/post/image/{{$new->post->banner}}" alt="" style="width: 100%">
                    ...
                    <a href="/berita/detail/{{$new->post->slug}}"style=" color:#000000;font-size:16px;font-weight:600;text-align:left;">Baca Artikel ></a>
                    <hr>
                  </a>
                </div>
              @endforeach
