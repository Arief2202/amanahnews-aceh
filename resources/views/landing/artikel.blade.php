    ...
    <section class="section" style="">
      <div class="container">
        <div class=" d-flex justify-content-center w-100">
          ...
          <div class="row">
              <div class="col">
                <input type="text" class="form-control" placeholder="Cari Artikel yang ingin anda baca" name="search" value="{{request('search')}}" style="width: 50vw; border-width: 2px 2px;">
              </div>
              <div class="col">
              ...
              @if(strval(request('search')) > 0)
                ...
                <div class="mb-3 w-100" data-aos="fade-up" data-aos-delay="50">
                  <a href="{{route('artikel.detail', ['slug' => $new->slug])}}">
                    ...
                    <a href="/artikel/detail/{{$new->slug}}"style=" color:#000000;font-size:16px;font-weight:600;text-align:left;">Baca Artikel ></a>
                    <hr>
                  </a>
                </div>
                @endforeach
    ...
    <section class="section" style="padding-top:0px;">
      <div class="container">
        ...
        <div class="row">
          ...
          <?php
            if(isset($selected_tag)) $lainnya = $lainnya->artikel;
          ?>
