...
@section('main')
    <section style="top: 0px; padding:0px; margin:0px;">
        <div class="" style="height: 500px">
            ...
            <img style="object-fit:cover;" style="object-fit:cover;" style="object-fit:cover;" style="object-fit:cover;" style="object-fit:cover;" src="/uploads/e-catalog/bg.png" alt="" style="position: absolute; width:100%; height:500px; z-index: 1; top:0px; opacity:7%;">
            <div class="topBar">
                    ...
                    <div class="col-md-3 p-2">
                        <a href="{{route('e-catalog.detail', ['slug' => $ecatalog->slug])}}">
                            <div class="shadow" style="border-radius: 15px">
                                <img style="object-fit:cover;" style="object-fit:cover;" style="object-fit:cover;" style="object-fit:cover;" style="object-fit:cover;" src="/uploads/e-catalog/image/{{$ecatalog->photo}}" alt="" style="width: 100%;">
                                <div class="p-3">
